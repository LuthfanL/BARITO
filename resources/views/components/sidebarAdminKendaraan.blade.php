    ...
    <nav class="mt-14 ml-3 mr-2 text-left">
        <ul>
            ...
            <li class="pl-1 py-7 transition-colors duration-200">
                <a href="/dashboardAdminKendaraan" class="flex items-center block text-gray-500 hover:text-black font-semibold" aria-label="Admin Ruangan">
            ...
            <!-- Buat Kendaraan -->
            <li class="pl-1 py-7 transition-colors duration-200">
                <a href="/buatKendaraan" class="flex items-center block text-gray-500 hover:text-black font-semibold" aria-label="Buat Ruangan">
                    <svg class="w-[32px] h-[32px] opacity-100 scale-100 ml-5 transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 group-hover:ml-5" 
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Daftar Kendaraan -->
            <li class="pl-1 py-7 transition-colors duration-200">
                <a href="/daftarKendaraan" class="flex items-center block text-gray-500 hover:text-black font-semibold" aria-label="Kelola Ruangan">
                    <svg class="w-[32px] h-[32px] opacity-100 scale-100 ml-5 transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 group-hover:ml-5" 
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M11 4.717c-2.286-.58-4.16-.756-7.045-.71A1.99 1.99 0 0 0 2 6v11c0 1.133.934 2.022 2.044 2.007 2.759-.038 4.5.16 6.956.791V4.717Zm2 15.081c2.456-.631 4.198-.829 6.956-.791A2.013 2.013 0 0 0 22 16.999V6a1.99 1.99 0 0 0-1.955-1.993c-2.885-.046-4.76.13-7.045.71v15.081Z" clip-rule="evenodd"/>
                    </svg>
                    <span class="transition-transform duration-100 transform translate-x-3 group-hover:translate-x-3">Daftar Kendaraan</span>
                </a>
            </li>
        
            <!-- Verifikasi Booking Kendaraan -->
            <li class="pl-1 py-7 transition-colors duration-200">
                <a href="/verifikasiBookingKendaraan" class="flex items-center block text-gray-500 hover:text-black font-semibold" aria-label="Verifikasi Booking">
                    <svg class="w-[32px] h-[32px] opacity-100 scale-100 ml-5 transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 group-hover:ml-5" 
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li class="pl-1 py-7 transition-colors duration-200">
                <a href="/riwayatBookingKendaraan" class="flex items-center block text-gray-500 hover:text-black font-semibold" aria-label="Riwayat Booking Kendaraan">
                    <svg class="w-[32px] h-[32px] opacity-100 scale-100 ml-5 transition-all duration-300 group-hover:opacity-100 group-hover:scale-100 group-hover:ml-5" 
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
