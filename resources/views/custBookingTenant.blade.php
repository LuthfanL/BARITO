            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 md:p-5">
                    <form id="booking-form">
                        ...
                        <input type="text" id="namaPemohon" name="namaPemohon" value="{{ old('namaPemohon') }}" require oninput="validateNamaPemohon(this)"  maxlength="30">
                        <script>
                        ...
                        <input type="text" id="noWa" name="noWa" value="{{ old('noWa') }}" require oninput="validateWhatsApp(this)"  maxlength="15">
                        <script>
                        ...
                        <input type="text" id="namaTenant" name="namaTenant" value="{{ old('namaTenant') }}" required  maxlength="30">
    ...
    <div id="modal-konfirmasi" data-modal-backdrop="static" tabindex="-1" class="hidden fixed inset-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
        <div class="relative w-full max-w-lg p-6 bg-white rounded-lg shadow-lg">
            ...
            <div class="text-center">
                ...
                <h1 class="text-xl font-bold text-gray-900">Konfirmasi Booking Tenant</h1>
            </div>
