        ...
        <div class="bg-white border border-white/10 rounded-2xl shadow-[0_0_20px_10px_rgba(0,0,0,0.1)] p-10 w-full max-w-sm backdrop-blur-lg">
            ...
            <div class="mt-8">
                ...
                <form action="{{ route('updatePW') }}" method="POST">
                    ...
                    <div class="my-6">
                        <div>
                            <input placeholder="Email" id="email" name="email" type="email" value="{{ old('email') }}" autocomplete="email" class="block w-full rounded-md bg-white-700 border border-gray-600 py-2 px-3 text-gray-300 focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                        </div>
                    </div>
                    <div class="my-6">
                        <div class="flex items-center relative">
                            <input placeholder="New Password" id="password" name="password" type="password" autocomplete="current-password" class="block w-full rounded-md bg-white-700 border border-gray-600 py-2 px-3 text-gray-300 focus:ring-2 focus:ring-indigo-500 focus:outline-none pr-10">
