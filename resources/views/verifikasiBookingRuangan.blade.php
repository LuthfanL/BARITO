        ...
        <div class="relative p-4 w-full max-w-xl max-h-full">
            <div class="relative bg-white rounded-lg shadow">
                <div class="p-4 md:p-5 text-center">
                    ...
                    <p class="mb-2 ml-2 mr-2 text-m font-normal text-gray-500">Apakah Anda yakin ingin menolak booking ruangan ini? Berikan alasan penolakan yang nantinya akan diberitahukan ke customer.</p>
                    @if (isset($booking))
                        <form action="{{ route('upStatusRuangan') }}" method="POST">
                        @csrf
                            <div class="p-4 md:p-5 space-y-6">
