                ...
                <form action="{{ route('registrasi') }}" method="POST">
                    ...
                    <div class="my-6">
                        <div class="flex items-center relative">
                            <input placeholder="Masukkan Password" id="password" name="password" type="password" autocomplete="new-password"  maxlength="10" class="block w-full rounded-md bg-white-700 border border-gray-600 py-2 px-3 text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:outline-none pr-10">
                    ...
                    <div class="my-6">
                        <div class="flex items-center relative">
                            <input placeholder="Konfirmasi Password" id="konfiramsiPassword" name="konfirmasiPassword" type="password" autocomplete="new-password"  maxlength="10" class="block w-full rounded-md bg-white-700 border border-gray-600 py-2 px-3 text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:outline-none pr-10">
