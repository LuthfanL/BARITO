...
<head>
    ...
    <title>Dashboard Admin Kendaraan</title>
        ...
        <div class="flex-grow">
            ...
            <div class="px-8 pt-5 flex justify-center items-center">
                <div class="grid grid-cols-12 w-full gap-14">
                    ...
                    <div class="col-span-3 bg-white-300 shadow-[0_0_20px_10px_rgba(0,0,0,0.1)] rounded-xl flex flex-col">
                        <div class="m-3 rounded-lg outline outline-2 outline-[#00C6BF] flex items-center justify-between">
                            <div>
                                <h2 class="text-left ml-3 mt-6 text-3xl font-bold">{{ $totalKendaraan }}</h2>
                                <p class="text-left text-gray-500 ml-3 mt-1 mb-6 text-lg font-semibold">Total Kendaraan</p>
                            </div>
                            <div class="mr-3">
                                <img width="58" height="58" src="https://img.icons8.com/sf-regular-filled/48/00c6bf/car.png" alt="car"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-8 pt-12 flex justify-center items-center">
                <div class="grid grid-cols-12 w-full gap-14">
                    ...
                    <!-- Statistik Kendaraan Terbooking -->
                    <div class="col-span-6 pt-24 pb-24 bg-white-300 shadow-[0_0_20px_10px_rgba(0,0,0,0.1)] rounded-xl flex flex-col">
                        <div>
                            <h2 class="text-left ml-3 mt-6 text-3xl font-bold">Statistik Kendaraan Terbooking</h2>
