        ...
        <div class="max-w-full w-full">
            ...
            @if ($bookings->where('status', 'Belum bayar')->count() > 0)
                <div id="alert-box" class="flex items-center p-4 mt-2 text-yellow-800 border-l-4 border-yellow-500 bg-yellow-100 rounded-lg shadow-md" role="alert">
                    ...
                    <div class="flex-1">
                        <strong>Perhatian!</strong> Anda memiliki pemesanan kendaraan yang belum dibayar. Mohon segera selesaikan pembayaran dan unggah bukti pembayaran paling lambat 24 jam setelah booking.
                    </div>
