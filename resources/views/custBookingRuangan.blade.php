            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 md:p-5">
                    <form id="booking-form">
                        ...
                        <input type="text" id="namaPemohon" name="namaPemohon" value="{{ old('namaPemohon') }}" required oninput="validateNamaPemohon(this)"  maxlength="30">
                        <script>
                        ...
                        <textarea id="keperluan" name="keperluan" rows="3" class="rounded-lg border border-gray-300" required  maxlength="50">{{ old('keperluan', null) }}</textarea>
                        ...
                        <textarea id="keterangan" name="keterangan" rows="3" class="rounded-lg border border-gray-300" required  maxlength="50">{{ old('keterangan', null) }}</textarea>
                        <p class="mb-4 text-xs text-gray-500">
    ...
    <div id="modal-konfirmasi" data-modal-backdrop="static" tabindex="-1" class="hidden fixed inset-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
        <div class="relative w-full max-w-lg p-6 bg-white rounded-lg shadow-lg">
            ...
            <div class="text-center">
                ...
                <h1 class="text-xl font-bold text-gray-900">Konfirmasi Booking Ruangan</h1>
            </div>
            ...
            <!-- Formulir -->
            <form action="{{ route('bookingRuangan.store') }}" method="POST" class="mt-6">
                @csrf    
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            konfirmasiButton.addEventListener('click', function() {
                ...
                const idRuangan = bookingForm.querySelector('input[name="idRuangan"]').value;
                ...
                document.getElementById('confirm-idRuangan').value = idRuangan;
