                                    ...
                                    <div class="flex justify-center gap-2">
                                        @if ($booking->status == 'Belum bayar')
                                            ...
                                            <button 
                                                ...
                                                data-bookingid="{{ $booking->id }}" 
                                                data-totalbiaya="{{ (\Carbon\Carbon::parse($booking->tglMulai)->diffInDays(\Carbon\Carbon::parse($booking->tglSelesai)) + 1) * $booking->ruangan->biayaSewa }}"
                                                data-biayaSewa="{{ $booking->ruangan->biayaSewa }}"
