...
<head>
    ...
    <title>Kontak Admin Tenant</title>
...
<div class="flex justify-center items-center min-h-screen px-4">
    ...
    <div class="w-full max-w-7xl bg-white shadow-[0_0_20px_10px_rgba(0,0,0,0.1)] rounded-xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div class="w-full md:w-1/2 bg-cover bg-center relative" style="background-image: url('assets/tenant.png');">
            <div class="absolute inset-0 flex flex-col justify-center px-6">
                ...
                <p class="pt-2 text-white text-xl sm:text-2xl font-bold text-center">Admin Tenant</p>
                <!-- Breadcrumb -->
