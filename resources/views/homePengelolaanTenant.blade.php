...
<body class="h-full bg-white">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span class="ms-1 text-sm font-medium text-white md:ms-2">Event Kami</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
    ...
    <div class="w-full">
        <div class="flex justify-center mt-12 shadow-[0_0_13px_3px_rgba(0,0,0,0.1)] p-8 space-x-8 ">
            ...
            <!-- Riwayat Booking -->
            <a href="custRiwayatBookingTenant" class="block transform transition-transform duration-300 hover:scale-105 group">
                <div class="bg-white-300 shadow-[0_0_12px_2px_rgba(0,0,0,0.1)] rounded-xl flex hover:shadow-xl">
                    <div class="m-3 rounded-lg outline outline-2 outline-[#00C6BF] flex items-center">
                        <div>
    ...
    <div class="flex justify-center pt-10">
        <h2 class="font-bold text-2xl">Event Terfavorit</h2>
    </div>
            ...
            <ul class="card-list swiper-wrapper">
                ...
                <li class="card-item swiper-slide">
                    <div href="" class="card-link">
                        ...
                        <p class="card-title">Banyak peminjaman: <strong>{{ $evt->total_peminjaman }}</strong></p>
                        <button 
