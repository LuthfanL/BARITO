...
Route::delete('/ruangan/{id}', [daftarRuanganController::class, 'destroy'])->name('ruangan.destroy')->middleware('auth');
...
Route::delete('/event/{namaEvent}', [daftarEventController::class, 'destroy'])->name('event.destroy')->middleware('auth');
